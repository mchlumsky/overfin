...
Overfin is an immutable Linux distribution based on [Project Bluefin's](https://projectbluefin.io/) bluefin-dx image (latest tag + intel/amd graphics) with some packages that I use on top.
